...
# #***************ToDo Liste & DropDown, Filter, GUI etc....**************
# getsubject_uid_temp = ""
# subject_name_temp = '"name"'
# ListNameMission = ""

# #***************ToDo Liste & DropDown, Filter, GUI etc....**************
# mission_list_length = len(a_missions_temp) # For show Data in ListBox
...
#           ListNameMission =  a_missions_temp[i].split(',')[0].split(':')[1].split('"')[1]
         
         

#      for val in range(1):
#          listbox.insert(val,ListNameMission)
      ...
      for i in range(mission_list_length):
          ...
          if str('"name"') in temp_str:
             if subject_name_temp in temp_str:
                ...
                print(getsubject_uid_temp)
                if not (getsubject_uid_temp == mission_list_length):
                    print("Error")
...
btnx = Button(text='Execute Barcode' , height = 18 , width =30, bg= "green" , command=com)
btnx.place(x=450 , y=50)



    
  
text = Entry(textvariable=b, validate="focusout"  ,  width =36 ,validatecommand=com)
text.place(x=450 ,y= 25)
